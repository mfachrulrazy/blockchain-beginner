...
class Blockchain(object):
    ...
    def __init__(self):
        # sinkron node untuk isi block
        self.nodes = set()

        self.chain = []
        self.current_transactions = []
        genesis_hash = self.hash_block("genesis_block_awal")
    ...
    def append_block(self, nonce, hash_of_previous_block):
        ...
        # reset transaksi lagi sebelum menambahkan block
        self.current_transactions = []
...
def sync():
    ...
    if updated:
        response = {
            'message': 'Blockchain telah ditambahkan dengan data terbaru',
            'blockchain': blockchain.chain
        }
    else:
        response = {
            'message': 'Sudah menggunakan block paling baru',
            'blockchain': blockchain.chain
        }
    return jsonify(response), 200
